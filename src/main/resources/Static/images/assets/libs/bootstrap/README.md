...
2. Run `npm run testData` (or a specific npm script) to rebuild distributed CSS and JavaScript files, as well as our docs assets.
...
Moreover, if your pull request contains JavaScript patches or features, you must include [relevant unit testData](https://github.com/twbs/bootstrap/tree/main/js/testData). All HTML and CSS should conform to the [Code Guide](https://github.com/mdo/code-guide), maintained by [Mark Otto](https://github.com/mdo).
...
Thanks to [BrowserStack](https://www.browserstack.com/) for providing the infrastructure that allows us to testData in real browsers!
